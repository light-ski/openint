...
<Step title="Set Up Your Connector">
    ...
    After signing up, navigate to the dashboard and set up your first connector. For example, you can configure an integration such as <strong>Google Docs</strong> or <strong>Greenhouse</strong>. This is where you can customize your integration settings to match your requirements.
</Step>
