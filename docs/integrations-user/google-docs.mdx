...
1. **Go to Integrations in {{APP_NAME}}:** Open {{APP_NAME}} and navigate to the integrations or connections section.
...
<Note>
{{APP_NAME}} will only request the minimum permissions needed for its features. You can review permissions at any time in your Google Account settings.
</Note>
...
If you continue to have problems, check {{APP_NAME}}’s help page or contact support for further assistance.
